...
<!--        <h2 class="text-white mb-4 text-center" data-aos="fade-up">Website Design Portfolio</h2><br> -->
    ...
    <div class="card" style="width: 18rem;">
       <div class="top-half"> <img class="" src="images/index/thumbnails/<?php echo $stuffs_image ?>" alt="Card image cap"></div>
        <div class="card-body">
            <h5 class="card-title"><?php echo $stuffs_title ?></h5>
            <p class="card-text"><?php echo $stuffs_tagline ?></p>
             <a data-fancybox data-src="#<?php echo $stuffs_permalink; ?>" href class="d-block photo-item btn">Learn More</a>
        </div>
    </div>
