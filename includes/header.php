    ...
    <main class="main-content">
      ...
      <script>
        function showMenu() {
          ...
          //         document.getElementById('header').classList.add("headerMobileHeight");

        }

        function hideMenu() {
          document.getElementById('mobileMenu').style.right = "-70%";
          //         document.getElementById('header').classList.remove("headerMobileHeight");
