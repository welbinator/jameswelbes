...
<div class="container-fluid index">
  <h2 id="indexH2" class="text-white mb-4 text-center" data-aos="fade-up">Here are some things I have done</h2>
  
  <div class="row index">
    <!-- Include portfolio things, using require_once for better error handling -->
